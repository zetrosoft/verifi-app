...
def verify_code_coverage(work_directory_path: str) -> bool:
    ...
    try:
        ...
        print(f"Code coverage: {total_percentage:.2f}% (Minimum required: {config.MINIMUM_COVERAGE_PERCENTAGE}%)")
        ...
        print(f"Error: pytest command not found. Ensure pytest is installed in the environment.")
        return False
